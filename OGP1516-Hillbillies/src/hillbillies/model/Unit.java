...
//		}
	...
	/**
 	...
 	private boolean isValidBoulder(Boulder boulder){
 		if (this.isTerminated())
 			return boulder == null;
 		return (boulder == null) || (!boulder.isTerminated() && (new Position(boulder.getWorld().getCubePosition(boulder.getPosition())) == new Position(this.getWorld().getCubePosition(this.getPosition())))||(this.isNeighbouringCube(boulder.getPosition())));
 	}
	 ...
	 */
 	...
 	private boolean isValidLog(Log log){
 		return (log == null) ||(!log.isTerminated() && (new Position(log.getWorld().getCubePosition(log.getPosition())) == new Position(this.getWorld().getCubePosition(this.getPosition())))|| this.isNeighbouringCube(log.getPosition()));
 	}
